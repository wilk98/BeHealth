...
namespace BeHealthBackend.Migrations
{
    public partial class Init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Doctor",
                columns: new[] { "Id", "AddressId", "Description", "Education", "Email", "FirstName", "LastName", "PhoneNumber", "Services", "Specialist" },
                values: new object[,]
                {
                    { 1, 1, null, null, "EugeniuszKaminski@dayrep.com", "Eugeniusz", "Kamiński", "519439105", null, "Oculist" },
                    { 2, 2, null, null, "SamKaczyński@dayrep.com", "Sam", "Kaczyński", "123432567", null, "Cardiologist" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, "AdelajdaZielinska@teleworm.us", "Adelajda", "Zielinska", "12345678901", "692435107" },
                    { 2, 2, "WitoldKwiatkowski@armyspy.com", "Witołd", "Kwiatkowski", "12345678901", "784251125" },
                    { 3, 3, "Wolny23@armyspy.com", "Arni", "Umbala", "12345678901", "879654239" },
                    { 4, 4, "JakubGrabowski@rhyta.com", "Jakub", "Grabowski", "12345678901", "531556254" }
                });
